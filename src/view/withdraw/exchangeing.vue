 ...
 */
  ...
  */
  ...
  const cancelOrderBill =async ()=>{
    let cancelOrdderUrl = "/api/trans/exchangecancel/"+orderId;
        ...
        <div class="margintop10 chargeing-lineheight">
          ...
          <div class="margintop20 font14">
              <button @click="()=>cancelDialog()" 
                class="search-btn-box search-btn-box-transparent bgbasecolor7 fontgrey search-btn-box-fixed">取消交换</button>
          </div>

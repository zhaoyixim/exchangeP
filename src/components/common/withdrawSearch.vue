...
import { useRouter } from "vue-router";
  ...
  import withdrawlist from "@/components/lists/withdrawlist.vue";
   ...
   */
   let searchdata = reactive({
        data:{
          ordernum:null,
          ordernet:[
            {cname:null,   labelvalue:0,selected:true, labelname:"请选择提币网络"},
          ...
          ordersts:[
            ...
            {labelvalue:11,selected:false,labelname:"提现中"},
            {labelvalue:12,selected:false,labelname:"提现成功"},
            {labelvalue:13,selected:false,labelname:"提现失败"},
            {labelvalue:14,selected:false,labelname:"提现取消"}         
          ]
        }
   })
  ...
  const searchordersts = (e:any)=>{   
   ...
   /**页面数据 */
   let pageInfo = reactive({currentPage:1,totalItems:10,pageSize:10,pageTotal:1,withdraw:true})
              ...
              <div class="select-area-charge "> 
                <div class="select-box ">
                  <select class="select-item2 fontdark font14"  
                     @change="(e)=>searchnet(e)" placeholder="请选择提现网络">
